...
my $g_regex_motorola_instruction =
	'abcd(?:b)?|add(?:b|l|w)?|adda(?:l|w)?|addi(?:b|l|w)?|addq(?:b|l|w)?'
.	'|addx(?:b|l|w)?|aline|and(?:b|l|w)?|andi(?:b|l|w)?|asl(?:b|l|w)?|asr(?:b|l|w)?'
.	'|bcc(?:l|s|w)?|bchg(?:b|l)?|bclr(?:b|l)?|bcs(?:l|s|w)?|beq(?:l|s|w)?|bfchg'
.	'|bfclr|bfexts|bfextu|bfffo|bfins|bfset|bftst|bge(?:l|s|w)?|bgt(?:l|s|w)?'
.	'|bhi(?:l|s|w)?|bhs(?:l|s|w)?|bitrev(?:l)?|bkpt|ble(?:l|s|w)?|blo(?:l|s|w)?'
.	'|bls(?:l|s|w)?|blt(?:l|s|w)?|bmi(?:l|s|w)?|bncc(?:l|s|w)?|bncs(?:l|s|w)?'
.	'|bne(?:l|s|w)?|bneq(?:l|s|w)?|bnge(?:l|s|w)?|bngt(?:l|s|w)?|bnhi(?:l|s|w)?'
.	'|bnhs(?:l|s|w)?|bnle(?:l|s|w)?|bnlo(?:l|s|w)?|bnls(?:l|s|w)?|bnlt(?:l|s|w)?'
.	'|bnmi(?:l|s|w)?|bnne(?:l|s|w)?|bnnz(?:l|s|w)?|bnpl(?:l|s|w)?|bnvc(?:l|s|w)?'
.	'|bnvs(?:l|s|w)?|bnz(?:l|s|w)?|bnze(?:l|s|w)?|bpl(?:l|s|w)?|bra(?:l|s|w)?'
.	'|bset(?:b|l)?|bsr(?:l|s|w)?|btst(?:b|l)?|bvc(?:l|s|w)?|bvs(?:l|s|w)?'
.	'|byterev(?:l)?|bze(?:l|s|w)?|callm|cas(?:b|l|w)?|cas2(?:l|w)?|chk(?:l|w)?'
.	'|chk2(?:b|l|w)?|cinva|cinvl|cinvp|clr(?:b|l|w)?|cmp(?:b|l|w)?|cmp2(?:b|l|w)?'
.	'|cmpa(?:l|w)?|cmpi(?:b|l|w)?|cmpm(?:b|l|w)?|cpusha|cpushl|cpushp|dbcc(?:w)?'
.	'|dbcs(?:w)?|dbeq(?:w)?|dbf(?:w)?|dbge(?:w)?|dbgt(?:w)?|dbhi(?:w)?|dbhs(?:w)?'
.	'|dble(?:w)?|dblo(?:w)?|dbls(?:w)?|dblt(?:w)?|dbmi(?:w)?|dbncc(?:w)?|dbncs(?:w)?'
.	'|dbne(?:w)?|dbneq(?:w)?|dbnf(?:w)?|dbnge(?:w)?|dbngt(?:w)?|dbnhi(?:w)?'
.	'|dbnhs(?:w)?|dbnle(?:w)?|dbnlo(?:w)?|dbnls(?:w)?|dbnlt(?:w)?|dbnmi(?:w)?'
.	'|dbnne(?:w)?|dbnnz(?:w)?|dbnpl(?:w)?|dbnt(?:w)?|dbnvc(?:w)?|dbnvs(?:w)?'
.	'|dbnz(?:w)?|dbnze(?:w)?|dbpl(?:w)?|dbra(?:w)?|dbt(?:w)?|dbvc(?:w)?|dbvs(?:w)?'
.	'|dbze(?:w)?|dec(?:b|l|w)?|divs(?:l|w)?|divsl(?:l)?|divu(?:l|w)?|divul(?:l)?|dos'
.	'|eor(?:b|l|w)?|eori(?:b|l|w)?|exg(?:l)?|ext(?:l|w)?|extb(?:l)?'
.	'|fabs(?:b|d|l|p|s|w|x)?|facos(?:b|d|l|p|s|w|x)?|fadd(?:b|d|l|p|s|w|x)?'
.	'|fasin(?:b|d|l|p|s|w|x)?|fatan(?:b|d|l|p|s|w|x)?|fatanh(?:b|d|l|p|s|w|x)?'
.	'|fbeq(?:l|w)?|fbf(?:l|w)?|fbge(?:l|w)?|fbgl(?:l|w)?|fbgle(?:l|w)?|fbgt(?:l|w)?'
.	'|fble(?:l|w)?|fblt(?:l|w)?|fbne(?:l|w)?|fbnge(?:l|w)?|fbngl(?:l|w)?'
.	'|fbngle(?:l|w)?|fbngt(?:l|w)?|fbnle(?:l|w)?|fbnlt(?:l|w)?|fboge(?:l|w)?'
.	'|fbogl(?:l|w)?|fbogt(?:l|w)?|fbole(?:l|w)?|fbolt(?:l|w)?|fbor(?:l|w)?'
.	'|fbra(?:l|w)?|fbseq(?:l|w)?|fbsf(?:l|w)?|fbsne(?:l|w)?|fbst(?:l|w)?|fbt(?:l|w)?'
.	'|fbueq(?:l|w)?|fbuge(?:l|w)?|fbugt(?:l|w)?|fbule(?:l|w)?|fbult(?:l|w)?'
.	'|fbun(?:l|w)?|fcmp(?:b|d|l|p|s|w|x)?|fcos(?:b|d|l|p|s|w|x)?'
.	'|fcosh(?:b|d|l|p|s|w|x)?|fdabs(?:b|d|l|p|s|w|x)?|fdadd(?:b|d|l|p|s|w|x)?|fdbeq'
.	'|fdbf|fdbge|fdbgl|fdbgle|fdbgt|fdble|fdblt|fdbne|fdbnge|fdbngl|fdbngle|fdbngt'
.	'|fdbnle|fdbnlt|fdboge|fdbogl|fdbogt|fdbole|fdbolt|fdbor|fdbra|fdbseq|fdbsf'
.	'|fdbsne|fdbst|fdbt|fdbueq|fdbuge|fdbugt|fdbule|fdbult|fdbun'
.	'|fddiv(?:b|d|l|p|s|w|x)?|fdiv(?:b|d|l|p|s|w|x)?|fdmove(?:b|d|l|p|s|w|x)?'
.	'|fdmul(?:b|d|l|p|s|w|x)?|fdneg(?:b|d|l|p|s|w|x)?|fdsqrt(?:b|d|l|p|s|w|x)?'
.	'|fdsub(?:b|d|l|p|s|w|x)?|fetox(?:b|d|l|p|s|w|x)?|fetoxm1(?:b|d|l|p|s|w|x)?'
.	'|ff1(?:l)?|fgetexp(?:b|d|l|p|s|w|x)?|fgetman(?:b|d|l|p|s|w|x)?'
.	'|fint(?:b|d|l|p|s|w|x)?|fintrz(?:b|d|l|p|s|w|x)?|fline|flog10(?:b|d|l|p|s|w|x)?'
.	'|flog2(?:b|d|l|p|s|w|x)?|flogn(?:b|d|l|p|s|w|x)?|flognp1(?:b|d|l|p|s|w|x)?'
.	'|fmod(?:b|d|l|p|s|w|x)?|fmove(?:b|d|l|p|s|w|x)?|fmovecr(?:x)?|fmovem(?:l|x)?'
.	'|fmul(?:b|d|l|p|s|w|x)?|fneg(?:b|d|l|p|s|w|x)?|fnop|fpack'
.	'|frem(?:b|d|l|p|s|w|x)?|frestore|fsabs(?:b|d|l|p|s|w|x)?'
.	'|fsadd(?:b|d|l|p|s|w|x)?|fsave|fscale(?:b|d|l|p|s|w|x)?|fsdiv(?:b|d|l|p|s|w|x)?'
.	'|fseq(?:b)?|fsf(?:b)?|fsge(?:b)?|fsgl(?:b)?|fsgldiv(?:b|d|l|p|s|w|x)?'
.	'|fsgle(?:b)?|fsglmul(?:b|d|l|p|s|w|x)?|fsgt(?:b)?|fsin(?:b|d|l|p|s|w|x)?'
.	'|fsincos(?:b|d|l|p|s|w|x)?|fsinh(?:b|d|l|p|s|w|x)?|fsle(?:b)?|fslt(?:b)?'
.	'|fsmove(?:b|d|l|p|s|w|x)?|fsmul(?:b|d|l|p|s|w|x)?|fsne(?:b)?'
.	'|fsneg(?:b|d|l|p|s|w|x)?|fsnge(?:b)?|fsngl(?:b)?|fsngle(?:b)?|fsngt(?:b)?'
.	'|fsnle(?:b)?|fsnlt(?:b)?|fsoge(?:b)?|fsogl(?:b)?|fsogt(?:b)?|fsole(?:b)?'
.	'|fsolt(?:b)?|fsor(?:b)?|fsqrt(?:b|d|l|p|s|w|x)?|fsseq(?:b)?|fssf(?:b)?'
.	'|fssne(?:b)?|fssqrt(?:b|d|l|p|s|w|x)?|fsst(?:b)?|fssub(?:b|d|l|p|s|w|x)?'
.	'|fst(?:b)?|fsub(?:b|d|l|p|s|w|x)?|fsueq(?:b)?|fsuge(?:b)?|fsugt(?:b)?'
.	'|fsule(?:b)?|fsult(?:b)?|fsun(?:b)?|ftan(?:b|d|l|p|s|w|x)?'
.	'|ftanh(?:b|d|l|p|s|w|x)?|ftentox(?:b|d|l|p|s|w|x)?|ftrapeq(?:l|w)?'
.	'|ftrapf(?:l|w)?|ftrapge(?:l|w)?|ftrapgl(?:l|w)?|ftrapgle(?:l|w)?'
.	'|ftrapgt(?:l|w)?|ftraple(?:l|w)?|ftraplt(?:l|w)?|ftrapne(?:l|w)?'
.	'|ftrapnge(?:l|w)?|ftrapngl(?:l|w)?|ftrapngle(?:l|w)?|ftrapngt(?:l|w)?'
.	'|ftrapnle(?:l|w)?|ftrapnlt(?:l|w)?|ftrapoge(?:l|w)?|ftrapogl(?:l|w)?'
.	'|ftrapogt(?:l|w)?|ftrapole(?:l|w)?|ftrapolt(?:l|w)?|ftrapor(?:l|w)?'
.	'|ftrapseq(?:l|w)?|ftrapsf(?:l|w)?|ftrapsne(?:l|w)?|ftrapst(?:l|w)?'
.	'|ftrapt(?:l|w)?|ftrapueq(?:l|w)?|ftrapuge(?:l|w)?|ftrapugt(?:l|w)?'
.	'|ftrapule(?:l|w)?|ftrapult(?:l|w)?|ftrapun(?:l|w)?|ftst(?:b|d|l|p|s|w|x)?'
.	'|ftwotox(?:b|d|l|p|s|w|x)?|illegal|inc(?:b|l|w)?|iocs|jbcc(?:l|s|w)?'
.	'|jbcs(?:l|s|w)?|jbeq(?:l|s|w)?|jbge(?:l|s|w)?|jbgt(?:l|s|w)?|jbhi(?:l|s|w)?'
.	'|jbhs(?:l|s|w)?|jble(?:l|s|w)?|jblo(?:l|s|w)?|jbls(?:l|s|w)?|jblt(?:l|s|w)?'
.	'|jbmi(?:l|s|w)?|jbncc(?:l|s|w)?|jbncs(?:l|s|w)?|jbne(?:l|s|w)?|jbneq(?:l|s|w)?'
.	'|jbnge(?:l|s|w)?|jbngt(?:l|s|w)?|jbnhi(?:l|s|w)?|jbnhs(?:l|s|w)?'
.	'|jbnle(?:l|s|w)?|jbnlo(?:l|s|w)?|jbnls(?:l|s|w)?|jbnlt(?:l|s|w)?'
.	'|jbnmi(?:l|s|w)?|jbnne(?:l|s|w)?|jbnnz(?:l|s|w)?|jbnpl(?:l|s|w)?'
.	'|jbnvc(?:l|s|w)?|jbnvs(?:l|s|w)?|jbnz(?:l|s|w)?|jbnze(?:l|s|w)?|jbpl(?:l|s|w)?'
.	'|jbra(?:l|s|w)?|jbsr(?:l|s|w)?|jbvc(?:l|s|w)?|jbvs(?:l|s|w)?|jbze(?:l|s|w)?|jmp'
.	'|jsr|lea(?:l)?|link(?:l|w)?|lpstop(?:w)?|lsl(?:b|l|w)?|lsr(?:b|l|w)?'
.	'|move(?:b|l|w)?|move16|movea(?:l|w)?|movec(?:l)?|movem(?:l|w)?|movep(?:l|w)?'
.	'|moveq(?:l)?|moves(?:b|l|w)?|muls(?:l|w)?|mulu(?:l|w)?|mvs(?:b|w)?|mvz(?:b|w)?'
.	'|nbcd(?:b)?|neg(?:b|l|w)?|negx(?:b|l|w)?|nop|not(?:b|l|w)?|or(?:b|l|w)?'
.	'|ori(?:b|l|w)?|pack|pbac(?:l|w)?|pbas(?:l|w)?|pbbc(?:l|w)?|pbbs(?:l|w)?'
.	'|pbcc(?:l|w)?|pbcs(?:l|w)?|pbgc(?:l|w)?|pbgs(?:l|w)?|pbic(?:l|w)?|pbis(?:l|w)?'
.	'|pblc(?:l|w)?|pbls(?:l|w)?|pbsc(?:l|w)?|pbss(?:l|w)?|pbwc(?:l|w)?|pbws(?:l|w)?'
.	'|pdbac(?:w)?|pdbas(?:w)?|pdbbc(?:w)?|pdbbs(?:w)?|pdbcc(?:w)?|pdbcs(?:w)?'
.	'|pdbgc(?:w)?|pdbgs(?:w)?|pdbic(?:w)?|pdbis(?:w)?|pdblc(?:w)?|pdbls(?:w)?'
.	'|pdbsc(?:w)?|pdbss(?:w)?|pdbwc(?:w)?|pdbws(?:w)?|pea(?:l)?|pflush|pflusha'
.	'|pflushan|pflushn|pflushr|pflushs|ploadr|ploadw|plpar|plpaw|pmove(?:b|l|q|w)?'
.	'|pmovefd(?:l|q)?|prestore|psac(?:b)?|psas(?:b)?|psave|psbc(?:b)?|psbs(?:b)?'
.	'|pscc(?:b)?|pscs(?:b)?|psgc(?:b)?|psgs(?:b)?|psic(?:b)?|psis(?:b)?|pslc(?:b)?'
.	'|psls(?:b)?|pssc(?:b)?|psss(?:b)?|pswc(?:b)?|psws(?:b)?|ptestr|ptestw'
.	'|ptrapac(?:l|w)?|ptrapas(?:l|w)?|ptrapbc(?:l|w)?|ptrapbs(?:l|w)?'
.	'|ptrapcc(?:l|w)?|ptrapcs(?:l|w)?|ptrapgc(?:l|w)?|ptrapgs(?:l|w)?'
.	'|ptrapic(?:l|w)?|ptrapis(?:l|w)?|ptraplc(?:l|w)?|ptrapls(?:l|w)?'
.	'|ptrapsc(?:l|w)?|ptrapss(?:l|w)?|ptrapwc(?:l|w)?|ptrapws(?:l|w)?|pvalid(?:l)?'
.	'|reset|rol(?:b|l|w)?|ror(?:b|l|w)?|roxl(?:b|l|w)?|roxr(?:b|l|w)?|rtd|rte|rtm'
.	'|rtr|rts|sats(?:l)?|sbcd(?:b)?|scc(?:b)?|scs(?:b)?|seq(?:b)?|sf(?:b)?|sge(?:b)?'
.	'|sgt(?:b)?|shi(?:b)?|shs(?:b)?|sle(?:b)?|slo(?:b)?|sls(?:b)?|slt(?:b)?'
.	'|smi(?:b)?|sncc(?:b)?|sncs(?:b)?|sne(?:b)?|sneq(?:b)?|snf(?:b)?|snge(?:b)?'
.	'|sngt(?:b)?|snhi(?:b)?|snhs(?:b)?|snle(?:b)?|snlo(?:b)?|snls(?:b)?|snlt(?:b)?'
.	'|snmi(?:b)?|snne(?:b)?|snnz(?:b)?|snpl(?:b)?|snt(?:b)?|snvc(?:b)?|snvs(?:b)?'
.	'|snz(?:b)?|snze(?:b)?|spl(?:b)?|st(?:b)?|stop|sub(?:b|l|w)?|suba(?:l|w)?'
.	'|subi(?:b|l|w)?|subq(?:b|l|w)?|subx(?:b|l|w)?|svc(?:b)?|svs(?:b)?|swap(?:w)?'
.	'|sxcall|sze(?:b)?|tas(?:b)?|tpcc(?:l|w)?|tpcs(?:l|w)?|tpeq(?:l|w)?|tpf(?:l|w)?'
.	'|tpge(?:l|w)?|tpgt(?:l|w)?|tphi(?:l|w)?|tphs(?:l|w)?|tple(?:l|w)?|tplo(?:l|w)?'
.	'|tpls(?:l|w)?|tplt(?:l|w)?|tpmi(?:l|w)?|tpncc(?:l|w)?|tpncs(?:l|w)?'
.	'|tpne(?:l|w)?|tpneq(?:l|w)?|tpnf(?:l|w)?|tpnge(?:l|w)?|tpngt(?:l|w)?'
.	'|tpnhi(?:l|w)?|tpnhs(?:l|w)?|tpnle(?:l|w)?|tpnlo(?:l|w)?|tpnls(?:l|w)?'
.	'|tpnlt(?:l|w)?|tpnmi(?:l|w)?|tpnne(?:l|w)?|tpnnz(?:l|w)?|tpnpl(?:l|w)?'
.	'|tpnt(?:l|w)?|tpnvc(?:l|w)?|tpnvs(?:l|w)?|tpnz(?:l|w)?|tpnze(?:l|w)?'
.	'|tppl(?:l|w)?|tpt(?:l|w)?|tpvc(?:l|w)?|tpvs(?:l|w)?|tpze(?:l|w)?|trap'
.	'|trapcc(?:l|w)?|trapcs(?:l|w)?|trapeq(?:l|w)?|trapf(?:l|w)?|trapge(?:l|w)?'
.	'|trapgt(?:l|w)?|traphi(?:l|w)?|traphs(?:l|w)?|traple(?:l|w)?|traplo(?:l|w)?'
.	'|trapls(?:l|w)?|traplt(?:l|w)?|trapmi(?:l|w)?|trapncc(?:l|w)?|trapncs(?:l|w)?'
.	'|trapne(?:l|w)?|trapneq(?:l|w)?|trapnf(?:l|w)?|trapnge(?:l|w)?|trapngt(?:l|w)?'
.	'|trapnhi(?:l|w)?|trapnhs(?:l|w)?|trapnle(?:l|w)?|trapnlo(?:l|w)?'
.	'|trapnls(?:l|w)?|trapnlt(?:l|w)?|trapnmi(?:l|w)?|trapnne(?:l|w)?'
.	'|trapnnz(?:l|w)?|trapnpl(?:l|w)?|trapnt(?:l|w)?|trapnvc(?:l|w)?|trapnvs(?:l|w)?'
.	'|trapnz(?:l|w)?|trapnze(?:l|w)?|trappl(?:l|w)?|trapt(?:l|w)?|trapv'
.	'|trapvc(?:l|w)?|trapvs(?:l|w)?|trapze(?:l|w)?|tst(?:b|l|w)?|unlk|unpk'
;
